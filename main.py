...
def generate_input(w, t):
    ...
    inputs = [-output(w[0], T, t), output(w[1], T, t), -output(w[2], T, t),
              ...
              output(w[6], T, t + T / 2), output(w[7], T, t + T / 2), -output(w[8], T, t + T / 2), 0, 0, 0, 0]
...
try:
    ...
    w_best = ([array([-7.26506485e-01, -8.38614787e-01, -5.56358174e-01,
                      ...
                      1.63209237e-01, -1.91754996e-01]),
               array([-1.49402493, 1.16777911, 0.07246947, -0.21257161, -0.3912605,
                      0.55184244, -0.67970783, -0.5405781]),
               array([0.0595232, -0.61581316, -0.62864344, -1.16207122, 0.45738423,
                      0.52816882, 0.22419772, -0.00324515]),
               array([0.17626497, -0.35013157, 0.7579556, -0.32839809, 0.17016797,
                      -0.47315695, -0.27232134, -0.1938231]),
               array([-0.11449376, 0.49809987, 1.36149742, 0.74359823, 0.56645939,
                      0.96690231, -0.14766671, 0.30231231]),
               array([-0.59583676, 0.05403124, -1.01776343, -0.5616875, 0.45425483,
                      0.22633419, 0.18381335, -0.65777158]),
               array([-0.02919157, 0.4980824, 0.64461859, -0.29464231, 0.33684163,
                      -0.76444424, -0.65709448, -1.31262128]),
               array([0.09118833, -0.14873715, 0.14209483, -0.80052937, 0.45015313,
                      -1.64013086, 0.21587223, 0.00546647]),
               array([0.55469414, 0.46425008, -0.28322548, -0.70177578, -0.53654581,
                      -0.07625724, 0.59847321, -0.98369352])])

    w_first = ([array([0.28032398, -0.22280502, -0.45912563, -0.13087411, 0.00131868,
                       -0.22360605, 0.29960409, -0.34270209]),
                array([0.15453372, -0.88020378, -0.06625429, -0.38944187, -0.4778913,
                       0.10231507, -0.7354027, -0.38999563]),
                array([-0.61151511, 0.08259072, -0.11728766, -0.78825239, 0.07503682,
                       0.3780213, 1.21214736, -0.34271815]),
                array([0.23661985, 0.2680493, 0.21691186, -0.48925347, 0.03141434,
                       0.05827253, 0.38333856, 0.12633454]),
                array([-0.60085352, -0.47220083, 0.53696127, 0.2804884, -0.27651353,
                       -0.14954568, -0.29866158, -0.21254649]),
                array([-0.26184373, -0.2953516, 0.51976833, 0.05279496, 0.53992931,
                       0.37088401, 0.07927318, -0.27730838]),
                array([-0.34321139, -0.23739512, 0.15111555, 0.32106653, 0.15391846,
                       0.99346677, 0.34962222, 1.03419399]),
                array([-0.68081062, -0.13637173, 0.65471814, -0.2885456, -0.77494225,
                       -0.2633149, 0.05738678, 1.0264855]),
                array([0.51705584, 0.40825768, 0.45069928, -0.18134995, 0.52601042,
