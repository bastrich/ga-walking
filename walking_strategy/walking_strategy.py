...
class WalkingStrategy:
    ...
    def __init__(self, fixed_period=None, fixed_type=None, fixed_sampling_interval=None, fixed_precision=None, initial_generation='perlin', frame_skipping='action_repeat', muscles=None):
        if muscles is not None:
            ...
            self.muscles = [Muscle(period=self.period, type=fixed_type, sampling_interval=fixed_sampling_interval, precision=fixed_precision, initial_generation=initial_generation, frame_skipping=frame_skipping) for _ in range(11)]
        else:
